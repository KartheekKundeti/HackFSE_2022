...
public class TransactionImpl implements TransactionalInterface{
	...
	public boolean deleteProduct(ProductVO pdt) {
		// TODO Auto-generated method stub
		List<BidingDO> product = bidRepository.findByName(pdt.getName());
		if(product.size()>0) {
	...
	@Override
	public List<ProductVO> showProductbycat(String productCat) {
		// TODO Auto-generated method stub
		List<ProductVO> list = transactionalRepo.findByCategory(productCat);
		return list;
	}
	
	@Override
	public Optional<ProductVO> showProductbyId(String productCat) {
		// TODO Auto-generated method stub
		Optional<ProductVO> list = transactionalRepo.findById(Long.parseLong(productCat));
		return list;
	}
	
	@Override
	public List<BidingDO> showAllbids(){
		List<BidingDO> biddingList = bidRepository.findAll();
		return biddingList;
	}
